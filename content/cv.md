    ...
    - title: Professional Experience
      sections:
        - company: Trumid
          ...
          duration: 3 yr
          data:
            - text: "Reduced costs: decreased LogScale (Humio) and Filebeat expenses by >$375k / year; saved $900k / year (7% of company's <abbr title='Amazon Web Services'>AWS</abbr> costs) by refining Karpenter <abbr title='Elastic Compute Cloud'>EC2</abbr> instance selection in <abbr title='Elastic Kubernetes Service'>EKS</abbr>."
            ...
            - text: "Improved LLM usage by updating repo prompts, adding references to Google's language style guides, and created custom slash commands for common workflows like Helm manifest rendering."
        ...
        - data:
            lines:
              ...
              - title: <abbr title="Large Language Models">LLMs / AI</abbr>
                text: Hooks, memories, docs, and slash commands for AI (Claude Code, Cursor, ChatGPT, Gemini)
